...
**Powerups explained:**
- **Sugar Rush** - doubles the money you make per click x 2(PER CLICK MEANING EITHER YOU MANUALLY CLICK OR CANDY FACTORY AUTO-CLICKS - DOES NOT AUTOMATICALLY GENERATE MONEY)
- **Candy Factory** - auto-clicks for you at the same rate of money you currently make(owning one of this powerup makes you $1 per click, owning two makes you $2 per click, owning three makes you $3 per click, etc.)(PER CLICK MEANING PER AUTOMATIC CLICK FROM THIS POWERUP)
...
- I'd made basic clicker buttons that didn't really do anything except increase the click count before, but this was my first time adding powerups that increased in price every time they were bought as well as the other features I added later.

<img width="1790" height="897" alt="Screenshot 2026-05-21 193206" src="https://github.com/user-attachments/assets/28ac8f25-9b51-4bdf-aebd-2ac07cbe51e5" />
